...
<div className="product-label">
                  ...
                  {woodFinishOptions.map((option) => (
                    <div 
                      ...
                      />
                              ...
                              {/* Product Label - Shows "Ancestry {Selected Size}" */}
  ...
  <div className="selection-content" onClick={toggleHandleOptions}>
    <div className="selection-preview">
      <img 
        src={handleOptions.find(option => option.name === handleType)?.image || "/api/placeholder/40/40"} 
        alt="Handle preview" 
        className="option-thumbnail" 
      />
      <div>
...
{/* {showHandleOptions && (
  <div className="expanded-options size-options">
    {handleOptions.map((option) => (
      <div 
        key={option.id}
        className={`size-option ${handleType === option.name ? 'selected' : ''}`}
...
{/* Expanded Handle Options - MODIFIED */}
{showHandleOptions && (
              <div className="expanded-options size-options">
                {handleOptions.map((option) => (
                  <div 
            ...
            {/* <div className="selection-row">
              <div className="selection-content">
                <div className="selection-preview">
                  <img src="/api/placeholder/40/40" alt="Handle finish preview" className="option-thumbnail" />
                  <div>
...
{/* // First find the Handle Finish section in the code and replace it with this implementation */}
...
{showHandleFinishOptions && (
  <div className="expanded-options">
    <div className="product-label">
      {/* <h3>Handle Finish for {handleType}</h3> */}
      <div className="separator-line"></div> 
    </div>
...
{/* Leg Options Selection - MODIFIED */}
<div className="selection-row">
