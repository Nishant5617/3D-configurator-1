...
import LegModel from "./LegModel";
import CanvasControls from "./CanvasControls";
import DimensionHelper from "./DimensionHelper"; // Import DimensionHelper
...
const SceneContent = ({
  ...
  return (
    <>
      ...
      {/* Display the dimensions when showMeasurements is true */}
      {showMeasurements && modelRef.current && (
        <DimensionHelper objectRef={modelRef} />
      )}
    </>
  );
};
